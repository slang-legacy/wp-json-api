...
1. [General concepts](#General-Concepts)  
   1.1. [Requests](#Requests)  
   1.2. [Controllers](#Controllers)  
   1.3. [Responses](#Responses)  
2. [Request methods](#Request-methods)  
   2.1. [Core controller methods](#Core-controller-methods)  
   2.2. [Posts controller methods](#Pages-controller-methods)  
   2.3. [Respond controller methods](#Respond-controller-methods)  
   2.4. [Widgets controller methods](#Widgets-controller-methods)  
3. [Request arguments](#Request-arguments)  
   3.1. [Output-modifying arguments](#Output-modifying-arguments)  
   3.2. [Content-modifying arguments](#Content-modifying-arguments)  
   3.3. [Using include/exclude and redirects](#Using-include/exclude-and-redirects)  
4. [Response objects](#Response-objects)  
   4.1. [Post response object](#Post-response-object)  
   4.2. [Category response object](#Category-response-object)  
   4.3. [Tag response object](#Tag-response-object)  
   4.4. [Author response object](#Author-response-object)  
   4.5. [Comment response object](#Comment-response-object)  
   4.6. [Attachment response object](#Attachment-response-object)  
5. [Extending JSON API](#Extending-JSON-API)  
   5.1. [Plugin hooks](#Plugin-hooks)  
   5.2. [Developing JSON API controllers](#Developing-JSON-API-controllers)  
   5.3. [Configuration options](#Configuration-options)  
6. [Unit tests](#Unit-tests)  
   6.1. [Preparing a WordPress test site](#Preparing-a-WordPress-test-site)  
   6.2. [Running the tests](#Running-the-tests)  
