...
if ( ! class_exists( 'WP_Importer' ) ) {
  $class_wp_importer = $WP_CORE_DIR . 'wp-admin/includes/class-wp-importer.php';
	if ( file_exists( $class_wp_importer ) )
		require $class_wp_importer;
}

$required = array(
	'post_exists' => $WP_CORE_DIR . 'wp-admin/includes/post.php',
	'wp_generate_attachment_metadata' => $WP_CORE_DIR . 'wp-admin/includes/image.php',
	'comment_exists' => $WP_CORE_DIR . 'wp-admin/includes/comment.php'
);
 ...
 * @subpackage Importer
 */
class AutoImporter extends WP_Importer {
...
function auto_import($args) {
	...
	$autoimport = new AutoImporter( $args );
...
auto_import(array(
    'file' => dirname(__FILE__) . '/theme-unit-test-data.xml',
    'map_user_id' => 1
));
